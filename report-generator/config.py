...
db = client["cto"]
datasetList = [{'oracleName': 'CodeShovel Training', 'oracleTye': 'Training', 'range': [1, 100]},
               {'oracleName': 'CodeShovel Testing', 'oracleTye': 'Testing', 'range': [101, 200]},
               {'oracleName': 'HistoryFinder Testing', 'oracleTye': 'Training', 'range': [201, 400]}]
