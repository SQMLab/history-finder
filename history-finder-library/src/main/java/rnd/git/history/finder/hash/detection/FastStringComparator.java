...
/**
 * More efficient (in terms of performance) implementation of a String
 * comparator. Speed is gained by using hash code as a primary comparison
 * attribute, which is cached for String. Be aware that this ordering is not
 * lexicographic, however stable.
 * 
 * example : FastStringComparator.INSTANCE.compare(s1, s2);
 */
